 ...
 * 
 *         This class also provides a pt.upskill.projeto1.status-bar (also composed of square images
...
public class ImageMatrixGUI {
	...
	/**
	 *
	 * Display a text on the pt.upskill.projeto1.status portion of the game window
	 *
	 * @param text
	 *            the pt.upskill.projeto1.status text to print in the GUI
	 *
	 */
	...
	/**
	 * 
	 * Add a new set of images to the pt.upskill.projeto1.status window.
	 * 
	 * @param newImages
	 *            images to be added to pt.upskill.projeto1.status bar
	 *
	 * @throws IllegalArgumentException
	 *             if no image with that name (and a suitable extension) is
	 *             found the images folder
	...
	// Added 2-Mar-2016
	/**
	 * Removes the image given as a parameter from the pt.upskill.projeto1.status bar.
	 * 
	 * Does nothing if there is no match.
	 * 
	 * @param image
	...
	// Added 2-Mar-2016
	/**
	 * Adds image to pt.upskill.projeto1.status window
	 * 
	 * @param image
	 *            to be added
	 */
	...
	/**
	 * Clear all images displayed in pt.upskill.projeto1.status window.
	 */
